"""
Django settings for restless_hall_dev_72238 project.
...
ROOT_URLCONF = 'restless_hall_dev_72238.urls'
...
WSGI_APPLICATION = 'restless_hall_dev_72238.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "restless_hall_dev_72238 API",
    "DESCRIPTION": "API documentation for restless_hall_dev_72238 App",
    "VERSION": "v1",
}
